        ...
        >
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                <Label htmlFor="mobile-description">Meta Description</Label>
                <Textarea
              ...
              <div>
                <Label htmlFor="mobile-keywords">Keywords</Label>
                <Input
                  id="mobile-keywords"
                  value={meta.keywords}
              ...
              <ThemeSelector selectedTheme={pageData.theme || "soft-pink"} onThemeChange={onThemeChange} />
            </div>
