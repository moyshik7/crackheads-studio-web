...
export function HeroMinimal({ content, isEditing, onEdit, theme }: HeroMinimalProps) {
        ...
        {isEditing ? (
          ...
          <>
            <div className="space-y-6">
              ...
              <p className="text-xl max-w-2xl mx-auto" style={{ color: theme?.colors.text || "#6b7280" }}>
            ...
            <div className="flex justify-center">
              <Button
                ...
                style={{ borderColor: theme?.colors.primary || "#3b82f6", color: theme?.colors.primary || "#3b82f6" }}
            ...
            <div className="pt-12">
              <img
                ...
                onError={(e) => {
                  console.error("HeroMinimal - Image failed to load:", currentContent.image)
