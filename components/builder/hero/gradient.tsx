...
export function HeroGradient({ content, isEditing, onEdit, theme }: HeroGradientProps) {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(45deg, ${theme?.colors.primary || "#3b82f6"}, ${theme?.colors.accent || "#8b5cf6"}, ${theme?.colors.secondary || "#f59e0b"})`,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          <div className="space-y-8 text-white">
            {isEditing ? (
              ...
              <>
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">{currentContent.title}</h1>
