...
export function HeroClassic({ content, isEditing, onEdit, theme }: HeroClassicProps) {
  ...
  const updateContent = (field: string, value: any) => {
    ...
    console.log("HeroClassic - Updating content:", field, "=", value)
    onEdit?.(newContent)
  }
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {isEditing ? (
              ...
              <>
                <div className="space-y-4">
                  ...
                  <p className="text-xl leading-relaxed" style={{ color: theme?.colors.text || "#6b7280" }}>
          ...
          <div className="relative">
            <img
              ...
              onError={(e) => {
                console.error("HeroClassic - Image failed to load:", currentContent.image)
