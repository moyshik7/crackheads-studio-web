...
export function MobileElementSelector({ onAddElement }: MobileElementSelectorProps) {
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50">
        <Button onClick={() => setIsOpen(!isOpen)} size="lg" className="h-14 w-14 rounded-full shadow-lg">
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-6 text-center">Add Element</h3>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`${section.color} w-4 h-4 rounded-full`} />
