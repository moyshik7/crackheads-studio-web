...
export function DividerComponent({ type, content, isEditing, onEdit, theme }: DividerProps) {
      ...
      <div className="space-y-4 p-4 border rounded-lg bg-gray-50">
        ...
        <div>
          ...
          <Input
            ...
            min="1"
            max="10"
            value={editContent.thickness || defaultContent.thickness}
            onChange={(e) => setEditContent({ ...editContent, thickness: e.target.value })}
          />
        </div>
        <div>
          ...
          <Input
            ...
            onChange={(e) => setEditContent({ ...editContent, spacing: e.target.value })}
          />
        </div>
      </div>
    )
    ...
    case "wavy":
      return (
        <div style={{ margin: `${currentContent.spacing}px 0` }}>
          <svg width="100%" height={currentContent.thickness * 4} viewBox="0 0 1200 24" preserveAspectRatio="none">
            <path
